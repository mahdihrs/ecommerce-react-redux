...
const dummies = [
  {
    ...
    name: 'INCOTEX',
    description: `
    An offshoot of the Slowear Group, Incotex specialises in the art of trouser-making. This slim-fit pair is cut from finely waled stretch-cotton corduroy that's not too heavy for summer, and carefully washed by hand for a faded colour and softer handle. Shown here with Altea sweater, Barena jacket, Common Projects sneakers. `,
    asset: incotex
  }, {
    name: 'RAYBAN',
